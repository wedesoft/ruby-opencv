...
=== GNU/Linux
* You need to install OpenCV. You can install OpenCV and the required dependencies using the package manager as follows:
 $ sudo aptitude install libcv-dev libcvaux-dev libhighgui-dev
